...
public class BookDetails extends JFrame 
{
    ...
    {
	new BookDetails().setVisible(true);//opening the book details frame
    }
    ...
    public BookDetails() //Constructor
    {
        //Creating a frame
        setLocation(80,100);
	...
	b1.addMouseListener(new MouseAdapter(){
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                {
                conn con = new conn();
                String sql = "select * from book where concat(book_name, book_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
	...
	b2.addMouseListener(new MouseAdapter(){
            public void mouseClicked(MouseEvent arg0)
            {
                ...
                {
                     conn con = new conn();
                      String sql = "delete from book where book_name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
	...
	JPanel panel = new JPanel();
        TitledBorder tb=new TitledBorder(new LineBorder(Color.BLACK,3),"BOOK DETAILS",TitledBorder.CENTER, TitledBorder.TOP,null, Color.CYAN);
	panel.setBorder(tb);
